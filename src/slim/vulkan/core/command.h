...
namespace gpu {
    ...
    void CommandBuffer::copy(const Buffer &from_buffer, const Image &to_image) const {
    ...
    void CommandBuffer::copy(const Image &from_image, const Buffer &to_buffer) const {
        VkBufferImageCopy region = {};
        region.bufferOffset = 0;
        region.bufferRowLength = 0;
        region.bufferImageHeight = 0;
    ...
    void CommandBuffer::copy(const Image &from_image,  u32 x, u32 y, const Buffer &to_buffer) const {
        VkBufferImageCopy region = {};
        region.bufferOffset = 0;
        region.bufferRowLength = 0;
        region.bufferImageHeight = 0;
    ...
    bool CommandBuffer::download(const Buffer &from_buffer, void** to_data, u64 size, u64 from_offset) const {
    ...
    bool CommandBuffer::upload(const void* from_data, const Buffer &to_buffer, u64 size, u64 to_offset) const {
    ...
    bool CommandBuffer::copy(const Buffer &from_buffer, const Buffer &to_buffer, u64 size, u64 from_offset, u64 to_offset) const {
        if (size == 0) size = from_buffer.total_size;
    ...
    bool CommandBuffer::resize(Buffer &buffer, u64 new_size) const {
        Buffer new_buffer{};
    ...
    void CommandBuffer::transitionImageLayout(Image &image, VkFormat format, VkImageLayout old_layout, VkImageLayout new_layout) const {
